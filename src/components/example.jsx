                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-2 sm:p-6 shadow-xl">
                    <div className="mb-4">
                        ...
                        <p className="text-gray-300">
                            Each point represents the relationship between
                            market penetration, ROI, and prevention efficiency
                        </p>
                    </div>
                    <div className="h-96">
            ...
            {financeData && (
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-2 sm:p-6 shadow-xl">
                    <div className="mb-4">
                        ...
                        <p className="text-gray-300">
                            3D visualization of financial metrics scaling with
                            user growth
                        </p>
                    </div>
                    <div className="h-96">
            ...
            {impactData && (
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-2 sm:p-6 shadow-xl">
                    <div className="mb-4">
                        ...
                        <p className="text-gray-300">
                            3D visualization of crime prevention scaling with
                            market penetration
                        </p>
                    </div>
                    <div className="h-96">
